...
To add a new route click on the **Add route** button. To modify an existing route click on the **Edit** button on the table record. To delete a route, click the three-dots menu **⋮** on the table record and press the **Delete** button.
