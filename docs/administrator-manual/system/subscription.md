...
- **Community subscription**: self-service registration mostly suited for IT consultant. For more info, see the [subscription plans](https://nethsecurity.org/subscription) page.

  Community subscription portal is available at [my.nethserver.com](https://my.nethserver.com)

- **Enterprise subscription**: service reserved to Nethesis resellers, please contact the [sales department](mailto:info@nethesis.it).
...
When the subscription expires, or at the end of a trial period, click the **Cancel registration** button.
