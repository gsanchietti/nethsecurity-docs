...
Per una configurazione DNS incentrata sulla privacy utilizzando connessioni crittografate, consulta [DNS over HTTPS con filtro](../advanced-cli/dns_over_http.md) per la configurazione DNS over HTTPS (DoH).
