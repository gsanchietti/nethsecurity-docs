...
Gli utenti all'interno del database locale possono ottenere [privilegi amministrativi](../installation/remote_access.md#admin_users-section) sull'interfaccia utente web abilitando l'opzione `Utente amministratore`. L'utente deve avere una password impostata.
